...
I forked thisbecause i like the name, i changed nothing but just ADD some generators to copy generators from gems(rails, simple_form, haml_rails, rspec-rails, inherited_resources) to current rails project's lib/generators for customization
...
Bundle install, then run rails g  nifty:install to see help messages
    ...
    rails g nifty:install:rspe_rails          # This will copy lib/generators in rspec-rails gem to lib/generators
